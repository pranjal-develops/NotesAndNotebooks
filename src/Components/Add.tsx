        ...
        <div className="flex-col">
          ...
          <div className="flex items-center justify-evenly px-2">
              ...
              <div className="flex flex-wrap gap-2">
                {COLORS.map((c) => (
                  <button
                    ...
                    className={`w-6 h-6 rounded-full border-2 transition-transform hover:scale-110 ${color === c.value ? 'border-(--accent-color) scale-110' : 'border-transparent'
                      }`}
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${pinned ? 'text-(--accent-color) bg-(--accent-color-light)' : 'text-zinc-400 hover:bg-zinc-100'
                }`}
            >
