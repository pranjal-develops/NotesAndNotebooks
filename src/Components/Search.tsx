...
const Search = () => {
  ...
  <input
    ...
    type="text"
    value={searchText}
    className="block w-full pl-10 pr-3 py-2 border border-transparent bg-gray-100 dark:bg-[hsl(0,0%,20%)] rounded-xl leading-5 placeholder-gray-500 focus:outline-none focus:bg-white dark:focus:bg-[hsl(0,0%,15%)] focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all sm:text-sm dark:text-gray-100"
