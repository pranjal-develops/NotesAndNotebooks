...
const NotesSection = () => {
  ...
  return (
    <section className='space-y-3'>
      <div className="flex items-center justify-between px-2 mb-2 text-xs font-semibold text-zinc-500 uppercase tracking-[0.22em] dark:text-slate-400">
        <span>Notes</span>
      ...
      {/* <div className="mt-8 border-t border-zinc-100 dark:border-zinc-800 pt-6"> */}
       <div className="space-y-2">
          <button onClick={() => handleTagClick(null)}
            className={`w-full flex items-center gap-3 px-3 py-2 text-sm rounded-xl transition-all group ${selectedTag === null
